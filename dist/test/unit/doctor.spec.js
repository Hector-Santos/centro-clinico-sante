...
const doctor_service_1 = require("../../src/doctor/doctor.service");
const doctor_factory_1 = require("../mocks/factories/doctor.factory");
...
describe('DoctorService', () => {
    ...
    beforeEach(async () => {
        ...
        service = moduleRef.get(doctor_service_1.DoctorService);
    });
    it('should create successfully', async () => {
        const input = (0, doctor_factory_1.CreateDoctorMock)();
    ...
    it('should return an doctor by ID', async () => {
        const target = (0, doctor_factory_1.DoctorMock)();
    ...
    it('should throw if doctor is not found', async () => {
        ...
        await expect(service.findOne('not-found')).rejects.toThrow('Doctor not found');
        expect(firebase_mock_1.mockCollection.doc).toHaveBeenCalledWith('not-found');
    });
    it('should return all doctors', async () => {
        const doctors = [(0, doctor_factory_1.DoctorMock)(), (0, doctor_factory_1.DoctorMock)()];
    ...
    it('should throw if fetching doctors fails', async () => {
        service.findAll.mockRejectedValueOnce(new Error('fetch failed'));
    ...
    it('should update an doctor successfully', async () => {
        ...
        const dto = (0, doctor_factory_1.UpdateDoctorMock)();
    ...
    it('should throw if update fails', async () => {
        ...
        firebase_mock_1.mockCollection.doc = jest.fn(() => ({ update: mockUpdate }));
        await expect(service.update('some-id', (0, doctor_factory_1.UpdateDoctorMock)())).rejects.toThrow('Firestore failure');
        expect(firebase_mock_1.mockCollection.doc).toHaveBeenCalledWith('some-id');
    });
